...
$mapper::$output_template['Other_Class'] = 'custom/Other_Class';
$test->assertEquals('custom/Other/Class.tpl.php', $mapper->map('Other_Class'), 'Map with underscore after remap and no namespace');
